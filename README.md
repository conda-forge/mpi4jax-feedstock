...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mpi4jax-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mpi4jax-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `mpi4jax` available on your platform:
...
```
pixi search mpi4jax --channel conda-forge
```
